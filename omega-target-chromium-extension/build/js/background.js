(function() {
  ...
  if ((typeof chrome !== "undefined" && chrome !== null ? (_ref = chrome.storage) != null ? _ref.sync : void 0 : void 0) || (typeof browser !== "undefined" && browser !== null ? (_ref1 = browser.storage) != null ? _ref1.sync : void 0 : void 0)) {
    ...
    chrome.storage.local.get('omega.local.syncOptions', function(res) {
  ...
  options._inspect = new OmegaTargetCurrent.Inspect(function(url, tab) {
    ...
    return actionForUrl(url).then(function(action) {
      var parsedUrl, title, urlDisp, _ref2;
      if (!action) {
        return;
      }
      ...
      title += action.title;
      if ((_ref2 = chrome.action) != null) {
        if (typeof _ref2.setTitle === "function") {
          _ref2.setTitle({
            title: title,
            tabId: tab.id
          });
  ...
  refreshActivePageIfEnabled = function() {
    return chrome.storage.local.get('omega.local.refreshOnProfileChange', function(res) {
      if (res['omega.local.refreshOnProfileChange'] === '"false"') {
        return;
      }
      return chrome.tabs.query({
        ...
        var url, _ref2;
        url = (_ref2 = tabs[0]) != null ? _ref2.url : void 0;
        if (!url) {
          return;
        }
